    ...
    <aside className="fixed inset-y-0 left-0 z-30 flex w-64 flex-col border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
      ...
      <div className="flex h-16 items-center gap-3 border-b border-slate-200 px-6 dark:border-slate-800">
        ...
        <div className="flex flex-col">
          <span className="font-bold text-slate-900 text-base tracking-tight dark:text-white flex items-center gap-1.5">
            Sigulon <span className="text-indigo-600">Voice</span>
          </span>
          <span className="text-[11px] font-medium text-slate-400">Voice AI Platform</span>
        </div>
      </div>
